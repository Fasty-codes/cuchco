  ...
  return (
    <div className="tool-page editor-page">
      ...
      <div className="tool-header editor-header">
        <a href="/" className="ce-tb-home" title="Home"><FiHome size={17}/></a>
        <div className="ce-tb-divider"/>
        <span className="ce-tb-brand">CUCHCO</span>
        <span className="ce-tb-slash">/</span>
        <span className="ce-tb-title">CODE PLAYGROUND</span>
        ...
        <div className="editor-header-controls">
          ...
          <div className="layout-toggle">
            <button className={`layout-btn${layout==="split"?" active":""}`} onClick={()=>setLayout("split")} title="Split"><FiColumns size={13}/></button>
            <button className={`layout-btn${layout==="editor"?" active":""}`} onClick={()=>setLayout("editor")} title="Editor"><FiCode size={13}/></button>
            <button className={`layout-btn${layout==="preview"?" active":""}`} onClick={()=>setLayout("preview")} title="Preview"><FiEye size={13}/></button>
          </div>
          ...
          >
            <FiZap size={12}/>{autoRun ? "Auto" : "Manual"}
          </button>

          {/* Run button */}
          {!autoRun && (
            <button className="run-btn" onClick={runPreview}><FiPlay size={12}/> Run</button>
          )}
        </div>
        <a href="/coding" className="ce-tb-back">← Coding</a>
      </div>
          ...
          <div className="editor-panel">
            ...
            <div className="editor-tabs">
              ...
              <div className="editor-tab-right">
                ...
                <button className="copy-btn" onClick={copyCode}>{copied ? <><FiCheck size={11}/> Copied</> : <><FiCopy size={11}/> Copy</>}</button>
              </div>
            </div>
      ...
      <div className="editor-statusbar">
        ...
        <span className="status-auto">{autoRun ? "⚡ Auto-run ON" : "Manual"}</span>
