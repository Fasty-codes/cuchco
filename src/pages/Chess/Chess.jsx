...
const ACC = "#B882FF";
const GLOW = "rgba(184,130,255,0.12)";

const TOOLS = [
  { icon:"♟️", label:"Chess Board",    badge:"FREE", desc:"Full-rules interactive board. Castling, en passant, promotion, checkmate detection — all built in.", href:"/chess/board" },
  { icon:"🧩", label:"Puzzle Trainer", badge:"FREE", desc:"Daily tactics — forks, pins, skewers, back-rank mates. Train pattern recognition every day.", href:"/chess" },
];
const COURSES = [
  { icon:"📚", label:"Opening Explorer", badge:"FREE", desc:"Italian, Sicilian, London — learn the theory, key ideas and deadly traps of every major opening.", href:"/chess" },
  { icon:"📊", label:"Game Analysis",    badge:"FREE", desc:"Engine evaluation bar, blunder detection, annotated move-by-move review of your games.", href:"/chess" },
  { icon:"🎓", label:"Endgame Studies",  badge:"FREE", desc:"King activation, opposition, pawn races. Master the most decisive phase of the game.", href:"/chess" },
];
    ...
    <>
      <nav className="nav">
        ...
        <div className="nav-center">
          ...
          <div className="nav-item"><a href="/chess"     className="nav-link" style={{color:ACC}}>Chess</a></div>
...
function HubCard({ item }) {
  return (
    <a href={item.href} className="hub-tool-card" style={{"--acc":ACC,"--acc-bg":"rgba(184,130,255,0.08)"}}>
    ...
    <div className="hub" style={{"--acc":ACC}}>
      ...
      <div className="hub-hero">
        ...
        <div className="hub-hero-inner">
          <div className="hub-eyebrow"><span className="hub-eyebrow-dot" style={{background:ACC}}/>DISCIPLINE 03</div>
          <h1>
            <span style={{color:ACC}}>CHESS</span>
            <span style={{color:"var(--text)"}}>TOOLS &</span>
            <span style={{color:"var(--text)"}}>COURSES</span>
          </h1>
          <p className="hub-hero-sub">Think. Calculate. Win. Train your board vision, openings and endgame mastery.</p>
      ...
      <div className="hub-premium">
        <div className="hub-premium-inner">
          ...
          <h2 className="hub-premium-title">PREMIUM <span>CHESS</span></h2>
          <p className="hub-premium-sub">Elite opening prep, engine-powered analysis and grandmaster-level endgame courses — coming soon.</p>
